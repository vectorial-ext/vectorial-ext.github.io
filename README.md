    ...
    <style>
        * {
        ...
        .cursor-dot {
            ...
            left: 0;
            top: 0;
            /* Центрируем элемент относительно его left/top */
        ...
        .cursor-dot-outline {
            ...
            filter: blur(8px);
            opacity: 0.5;
            /* Ускоряем transition transform для более отзывчивого следа */
            transition: transform 0.05s ease-out, opacity 0.3s ease, filter 0.3s ease, width 0.3s ease, height 0.3s ease; 
        }
        
        /* --- ТАНЦУЮЩАЯ ЛЯГУШКА (теперь Hoodwink) --- */
        .dancing-frog {
            position: fixed;
            bottom: 20px;
            right: 20px;
            width: 120px; /* Размер может быть изменен в зависимости от новой гифки */
            height: 120px; /* Размер может быть изменен в зависимости от новой гифки */
            z-index: 50; 
            /* НОВАЯ GIF: Hoodwink из Dota 2 */
            background: url('https://media1.tenor.com/m/d-6JxTn7Xr0AAAAd/hoodwink-dota.gif') no-repeat center center; 
    ...
    <script>
        ...
        document.addEventListener('mousemove', (e) => {
            requestAnimationFrame(() => {
                ...
                cursorDotOutline.style.left = x;
                cursorDotOutline.style.top = y;
            });
        });
        
        document.querySelectorAll('a, button, .btn, .pricing-card, .feature-card').forEach(element => {
            element.addEventListener('mouseenter', () => {
                cursorDot.style.width = '12px';
                cursorDot.style.height = '12px';
                cursorDotOutline.style.opacity = '0.8';
                cursorDotOutline.style.filter = 'blur(4px)';
                cursorDotOutline.style.width = '50px';
                cursorDotOutline.style.height = '50px';
            });
            element.addEventListener('mouseleave', () => {
                cursorDot.style.width = '8px';
                cursorDot.style.height = '8px';
                cursorDotOutline.style.opacity = '0.5';
                cursorDotOutline.style.filter = 'blur(8px)';
